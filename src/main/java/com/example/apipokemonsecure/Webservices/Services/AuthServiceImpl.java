...
import com.example.apipokemonsecure.Repository.IAuthRoleRepository;
import com.example.apipokemonsecure.Repository.IAuthUserRepository;
...
public class AuthServiceImpl implements AuthService, UserDetailsService {
    ...
    public void addRoleToUser(String username, String roleName) {
        ...
        AuthUser user = userRepository.findByUsername(username);
        AuthRole role = roleRepository.findByRoleName(roleName);
